...
public class Prefs extends PreferenceActivity implements OnSharedPreferenceChangeListener {
	...
	private static final String AUTHOR_SEARCH_DEF = "";
	 ...
	 private Preference returnDialogPreference; 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//the new version takes effect in version 11- can add implementation for
    ...
    // this.returnDialogPreference = getPreferenceScreen().findPreference("returnDialog");  
	...
	public static char getArrangeBy(Context context){
		String arrange = PreferenceManager.getDefaultSharedPreferences(context).getString(ARRANGE_BY, ARRANGE_BY_DEF);
		return arrange.charAt(0);
	}
	public static char getFilterByStatus(Context context){
		String status = PreferenceManager.getDefaultSharedPreferences(context).getString(FILTER_BY_STATUS, FILTER_BY_STATUS_DEF);
		return status.charAt(0);
	}
	public static char getFilterByRating(Context context){
		String rating = PreferenceManager.getDefaultSharedPreferences(context).getString(FILTER_BY_RATING, FILTER_BY_RATING_DEF);
		return rating.charAt(0);
	}
	public static String getAuthorSearch(Context context){
		return PreferenceManager.getDefaultSharedPreferences(context).getString(AUTHOR_SEARCH, AUTHOR_SEARCH_DEF); 
	}
	public static String getTitleSearch(Context context){
		return PreferenceManager.getDefaultSharedPreferences(context).getString(TITLE_SEARCH, TITLE_SEARCH_DEF); 
	}
